...
export const TradeResultsFromId = ({tradeResult}: {tradeResult: TradeResult}) => {
            ...
            <div className={styles.tradeContainer}>
                <div className={styles.tradeHeader}>
                    { tradeResult.isTradeValid ? 
                        <img className={styles.tradeIcon} src="../images/success-check.svg"></img> :
                        <img className={styles.tradeIcon} src="../images/fail-x.png"></img>
                    }
                    <div className={styles.tradeHeaderTitle}>Trade {tradeResult.isTradeValid ? "Works" : "Failed"}</div>
                    { tradeResult.isTradeValid === false && <div className={styles.tradeSubTitle}>{tradeResult.tradeFailedReason}</div> }
                    <div className={styles.buttonsContainer}>
                        <button className={styles.tradeButton} onClick={handleRestart}><span>Restart</span><img src="../images/restart-white.png"/></button>
                        <button className={styles.tradeButton} onClick={handleEdit}><span>Edit</span><img src="../images/swap-white.png"/></button>
                        <button className={styles.tradeButton} onClick={handleSave}><span>Save</span><img ref={saveImg} src="../images/heart-white.png"/></button>
                    </div>
                </div>
                        ...
                        tradeResult.trade.teams.map((team, index) => {
                            return (
                                <div key={index} className={styles.tradeTeam}>
                                    <TeamPreview team={team} selectedPlayers={tradeResult.trade.playersInTrade.filter(player => player.toTeamName == team.teamName)} />
                                </div>
                            )
                        })
                    }
